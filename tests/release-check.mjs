...
check('Sapsan and Lastochka reference cards have distinct accents', source.includes('function speedTrainClass') && source.includes('.routeCard.train-sapsan{') && source.includes('.routeCard.train-lastochka{') && source.includes('#v-speedref.train-sapsan #srTitle') && source.includes('#v-speedref.train-lastochka #srTitle'));
